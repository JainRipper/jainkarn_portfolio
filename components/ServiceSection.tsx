  ...
  return (
    <motion.section id="services" initial={{ opacity: 0 }} animate={{ opacity: 1 }}
      ...
      <div className="items-center container">
        {/* Intro */}
        <div className="mb-16 md:flex md:justify-between sm:items-center container mx-auto" >
          <div className="w-full md:w-1/2 text-left">
            <h1 className="font-archivo font-bold text-center md:text-left text-4xl lg:text-5xl text-ternary-dark dark:text-primary-light" >
              {data.intro.heading}
            </h1>
          ...
          <div className="w-full md:w-1/2 text-right md:ml-6">
            <div className="mt-8 md:mt-0 md:ml-4 flex p-5 sm:p-0 justify-center items-center md:float-right">
              { data.achievement.map((item: any, i: number) => (
                <div className="flex-col ml-10" key={i}>
                  <h1 className="font-archivo font-bold text-4xl md:w-3/4 lg:text-5xl text-left text-ternary-dark dark:text-primary-light" >
                    {item.time}
                  </h1>
                  <p className="font-general-medium mt-4 text-base md:text-lg text-left leading-normal text-gray-500 dark:text-gray-200" >
                    {item.title}
                  </p>              
                </div>              
                ))}
